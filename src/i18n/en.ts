...
const en = {
  ...
  "messageList.emptyDescription":
    "Start a conversation with CodePilot. Ask questions, get help with code, or explore ideas.",
  ...
  "settings.autoApproveDialogDesc":
    "This will bypass all permission checks. Claude will be able to execute any tool action without asking for your confirmation, including:",
  ...
  "settings.autoApproveTrustWarning":
    "Only enable this if you fully trust the task at hand. This setting applies to all new chat sessions.",
  ...
  "settings.cliPathDesc":
    "Custom path to Claude CLI executable. Leave empty to auto-detect.",
  "settings.cliPathPlaceholder": "Auto-detect (default)",
  "settings.cliPathSaved": "CLI path saved",
  "settings.cliPathInvalid":
    "File not found at this path. Setting saved but will fall back to auto-detect.",
  "settings.configDirTitle": "Claude Config Directory",
  "settings.configDirDesc":
    "Custom path to Claude config directory (e.g. ~/.claude-internal). Leave empty for ~/.claude.",
  "settings.configDirPlaceholder": "~/.claude (default)",
  "settings.configDirSaved": "Config directory saved",
  "settings.configDirInvalid":
    "Directory not found at this path. Setting saved but will fall back to ~/.claude.",
  ...
  "provider.ccSwitchHint":
    "Claude Code configurations added via tools like cc switch may not be readable by CodePilot. We recommend re-adding your provider here.",
  "provider.addProviderSection": "Add Provider",
  "provider.addProviderDesc":
    "Select a provider to connect. Most presets only require an API key.",
  ...
  "skills.marketplaceHintDesc":
    "Search and install community skills from Skills.sh",
  ...
  "connection.installPrompt":
    "To use Claude Code features, you need to install the Claude Code CLI.",
  ...
  "install.homebrewDescription":
    "Homebrew is the package manager for macOS. Node.js installation requires it.",
  ...
  "imageGen.toggleTooltip":
    "Toggle Image Agent — AI analyzes intent and generates single or batch images",
  ...
  "imageGen.noApiKey":
    "Please configure Gemini API Key in Settings > Providers",
  ...
  "imageGen.multiTurnHint":
    "You can describe changes to modify the generated image",
  ...
  "batchImageGen.stylePromptPlaceholder":
    "Describe the visual style for all images...",
  "batchImageGen.uploadDocs": "Upload Documents",
  "batchImageGen.uploadDocsHint":
    "Upload text/markdown files as source content",
  ...
  "batchImageGen.noProvider":
    "Please configure a text generation provider in Settings",
  ...
  "provider.geminiImageDesc":
    "Nano Banana Pro — AI image generation by Google Gemini",
  ...
  "telegram.chatIdHint":
    'Send /start to your bot first, then click "Auto Detect" to fill in your Chat ID',
  "telegram.detectChatId": "Auto Detect",
  "telegram.chatIdDetected": "Chat ID detected: {id} ({name})",
  "telegram.chatIdDetectFailed":
    "Could not detect Chat ID. Send /start to the bot first, then try again.",
  ...
  "telegram.step5":
    'Send /start to your bot, then click "Auto Detect" next to the Chat ID field',
  ...
  "feishu.domainHint":
    "Choose Feishu for China mainland or Lark for international",
  ...
  "feishu.allowedUsersDesc":
    "Comma-separated open_id or chat_id values allowed to use bridge",
  ...
  "feishu.groupAllowFromHint":
    "Comma-separated chat_id values of allowed groups",
  "feishu.requireMention": "Require @mention",
  "feishu.requireMentionDesc":
    "Only respond in groups when the bot is @mentioned",
  "feishu.setupGuide": "Setup Guide",
  "feishu.step1":
    "Go to Feishu Open Platform (open.feishu.cn) and create a custom app",
  ...
  "feishu.step6":
    'Paste the credentials above and click "Test Connection" to verify',

  // ── Settings: Remote Bridge ────────────────────────────────
  "settings.bridge": "Remote Bridge",
  "bridge.title": "Remote Bridge",
  "bridge.description":
    "Control Claude from external channels like Telegram or Feishu",
  "bridge.enabled": "Enable Remote Bridge",
  "bridge.enabledDesc":
    "Allow external messaging channels to interact with Claude",
  "bridge.activeHint":
    "Bridge is active. External channels can send tasks to Claude.",
  ...
  "bridge.autoStartDesc":
    "Automatically start the bridge when the application launches",
  ...
  "bridge.telegramSettingsDesc":
    "Configure Telegram Bot credentials for bridge",
  "bridge.allowedUsers": "Allowed Users",
  "bridge.allowedUsersDesc":
    "Comma-separated Telegram user IDs allowed to use bridge",
  "bridge.allowedUsersHint":
    "Leave empty to allow only the Chat ID configured above",
  ...
  "bridge.discordChannelDesc":
    "Receive and respond to messages via Discord Bot",
  ...
  "discord.allowedUsersDesc":
    "Control which users and channels can interact with the bot",
  "discord.allowedUserIds": "Allowed User IDs",
  "discord.allowedUsersHint":
    "Discord user IDs, comma-separated for multiple. Denies all when both users and channels are empty.",
  "discord.allowedChannelIds": "Allowed Channel IDs",
  "discord.allowedChannelsHint":
    "Discord channel IDs, comma-separated for multiple.",
  "discord.guildSettings": "Server & Group Settings",
  "discord.guildSettingsDesc":
    "Control how the bot responds in Discord servers",
  "discord.allowedGuilds": "Allowed Server (Guild) IDs",
  "discord.allowedGuildsHint":
    "Guild IDs, comma-separated for multiple. Leave empty to allow all servers.",
  "discord.groupPolicy": "Server Message Policy",
  "discord.groupPolicyOpen": "Open — respond in all server channels",
  "discord.groupPolicyDisabled":
    "Disabled — ignore all server messages (DM only)",
  "discord.requireMention": "Require @mention",
  "discord.requireMentionDesc":
    "Only respond in servers when the bot is @mentioned",
  "discord.streamPreview": "Stream Preview",
  "discord.streamPreviewDesc":
    "Show real-time response preview by editing messages",
  "discord.setupGuide": "Configuration Guide",
  "discord.setupBotTitle": "Create a Discord Bot",
  "discord.step1":
    'Go to Discord Developer Portal (discord.com/developers), click "New Application" to create an app',
  "discord.step2":
    'Navigate to "Bot" in the sidebar, click "Add Bot" to create the bot',
  "discord.step3":
    'Scroll down to "Privileged Gateway Intents", enable the "MESSAGE CONTENT INTENT" toggle',
  "discord.step4":
    'Click "Reset Token" to copy the Bot Token, paste it in the "Bot Credentials" section above and save',
  "discord.step5":
    'Go to "OAuth2 → URL Generator", check "bot" under Scopes, then check "Send Messages" and "Read Message History" under Bot Permissions',
  "discord.step6":
    "Copy the generated invite URL, open it in your browser to invite the Bot to your server",
  "discord.step7":
    'Click "Test Connection" above — if the bot name appears, setup is complete',
  "discord.setupIdTitle": "Getting IDs (Developer Mode required)",
  "discord.stepDevMode":
    'Open Discord → User Settings → Advanced → enable "Developer Mode"',
  "discord.stepUserId":
    'User ID: right-click your avatar or username → "Copy User ID"',
  "discord.stepChannelId":
    'Channel ID: right-click a channel name in the sidebar → "Copy Channel ID"',
  "discord.stepGuildId":
    'Server ID: right-click the server name at the top-left → "Copy Server ID"',
} as const;

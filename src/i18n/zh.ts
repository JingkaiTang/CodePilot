...
const zh: Record<TranslationKey, string> = {
  ...
  "settings.cliPathDesc": "自定义 Claude CLI 可执行文件路径。留空则自动检测。",
  "settings.cliPathPlaceholder": "自动检测（默认）",
  "settings.cliPathSaved": "CLI 路径已保存",
  "settings.cliPathInvalid":
    "该路径下未找到可执行文件。配置已保存，但会回退到自动检测。",
  "settings.configDirTitle": "Claude 配置目录",
  "settings.configDirDesc":
    "自定义 Claude 配置目录路径（如 ~/.claude-internal）。留空则使用 ~/.claude。",
  "settings.configDirPlaceholder": "~/.claude（默认）",
  "settings.configDirSaved": "配置目录已保存",
  "settings.configDirInvalid":
    "该路径下未找到目录。配置已保存，但会回退到 ~/.claude。",
  "settings.usage": "用量统计",
  ...
  "provider.ccSwitchHint":
    "通过类似 cc switch 等工具添加的 Claude Code 配置可能无法被 CodePilot 读取，建议在此处重新添加。",
  ...
  "install.homebrewDescription":
    "Homebrew 是 macOS 的包管理器，安装 Node.js 需要它。",
